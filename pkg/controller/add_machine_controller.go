...
//+kubebuilder:rbac:groups=ironic.k8s.io,resources=ironicmachineproviderspecs;ironicmachineproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
