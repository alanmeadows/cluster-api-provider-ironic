...
//+kubebuilder:rbac:groups=ironic.k8s.io,resources=ironicclusterproviderspecs;ironicclusterproviderstatuses,verbs=get;list;watch;create;update;patch;delete
func init() {
